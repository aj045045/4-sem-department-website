                    ...
                    <td class="row"><b>Semester 1 Syllabus :
                            <form action="">
                                ...
                                <span class="icon-input-btn"><i class="fa fa-download"></i>
                                    <input type="submit" class="btn btn-outline-primary" name="download-pdf" value="  Downloads">
                        </b></td>
                    </span></b></td>
                    </form>
                    <td></td>
            ...
            <tbody>
                ...
                <tr>
                    <td class="row"><b>Semester 2 Syllabus :<form action="">
                                ...
                                <input type="hidden" name="sem" value="2">
                                <span class="icon-input-btn"><i class="fa fa-download"></i>
                                    <input type="submit" class="btn btn-outline-primary" name="download-pdf" value="  Downloads"></b>
                    </td>
                    </span>
                    </b></td>
                    </form>

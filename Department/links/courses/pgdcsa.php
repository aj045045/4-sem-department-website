      ...
      <thead class="text-center text-white bg-red-800 ">
        ...
        <tbody>
            <tr>
                ...
                <td class="px-6 pt-0"> In this course, students learn varitey of subjects such as Basic Computer Operations,Office Suite,Operating System,Programming skill and logic development using C language,Object Oriented Concepts and its implementation using Python,Database Management Systems ,Web Designing and Web Application Development through PHP,Tally and many more</td>

...
<body class=" bg-slate-300">
    ...
    <div class=" bg-white rounded-lg w-4/5 mx-auto  shadow-lg">
        <table class="sm:w-11/12 w-8/12 mt-10 text-sm text-justify font-sanserif sm:text-md table-auto mx-auto ">
            <thead class="font-bold text-center capitalize">
                <tr class="sm:border-b-2 border-b-2 border-gray-400 ">
                        ...
                        <tr class="font-sans hover:bg-slate-200 ">
                            <td class="py-2">
                                <form action="" method="post" id="approved">
                                    <input checked type="checkbox" name="userIdDeclined" value="<?php echo $row['user_id']; ?>" class=" accent-blue-500 w-4 h-4">
                                    <input checked type="checkbox" name="userIdApproved" value="<?php echo $row['user_id']; ?>" class="sm:ml-4 w-4 h-4 accent-red-500 l-2">
                                </form>
                            </td>

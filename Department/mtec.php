...
<body class="mx-3 sm:mx-5">
    <div class="flex flex-initial h-20 px-10 mt-6 bg-yellow-600 sm:px-32 sm:h-32 ">
    ...
    <div class="flex flex-initial mx-10 mt-6 sm:mx-32 ">
        ...
        <div class="w-full ">
            ...
            <div
                class="mt-6 font-semibold text-center text-white rounded-lg bg-gradient-to-r from-blue-50 to-yellow-700">
